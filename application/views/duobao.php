...
ul.cateprolist li i.duobaochenggong{position: absolute;left: 90px;top: 25px;height: 60px;width: 60px;z-index: 2;background-image:url('/data/file/images/icon2/duobaochenggong.png');}
ul.cateprolist li i.duobaoshibai{position: absolute;left: 90px;top: 25px;height: 60px;width: 60px;z-index: 2;background-image:url('/data/file/images/icon2/duobaoshibai.png');}
</style>
<body>
	<header class="back">
		<tit>一元夺宝</tit>
